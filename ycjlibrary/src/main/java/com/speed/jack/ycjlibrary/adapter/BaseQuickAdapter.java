package com.speed.jack.ycjlibrary.adapter;
...
import com.speed.jack.ycjlibrary.R;
import com.speed.jack.ycjlibrary.animation.AlphaInAnimation;
import com.speed.jack.ycjlibrary.animation.BaseAnimation;
import com.speed.jack.ycjlibrary.animation.CustomAnimation;
import com.speed.jack.ycjlibrary.animation.ScaleInAnimation;
import com.speed.jack.ycjlibrary.animation.SlideInBottomAnimation;
import com.speed.jack.ycjlibrary.animation.SlideInLeftAnimation;
import com.speed.jack.ycjlibrary.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * more infomation see{@link  public void openLoadMore(int pageSize, boolean enable),@link
     * public void setOnLoadMoreListener(RequestLoadMoreListener requestLoadMoreListener)} method
     */
    @Deprecated
    ...
    /**
     * call the method before you should call setPageSize() method to setting up the enablePagerSize
     * value,whether it will  invalid
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        @Override public void onClick(View v) {
            if (mChildClickListener != null) {
                mChildClickListener.onItemChildClick(BaseQuickAdapter.this, v,
    ...
    @Override public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                ...
                convert((BaseViewHolder) holder,
                        mData.get(holder.getLayoutPosition() - getHeaderViewsCount()), positions);
                addAnimation(holder);
                break;
            case LOADING_VIEW:
                addLoadMore(holder);
            ...
            default:
                ...
                convert((BaseViewHolder) holder,
                        mData.get(holder.getLayoutPosition() - getHeaderViewsCount()), positions);
                onBindDefViewHolder((BaseViewHolder) holder,
                        mData.get(holder.getLayoutPosition() - getHeaderViewsCount()));
                break;
        }
    }
     ...
     */
    @Deprecated public void isNextLoad(boolean isNextLoad) {
    ...
    private boolean isLoadMore() {
        return mNextLoadEnable && pageSize != -1 && mRequestLoadMoreListener != null &&
                mData.size() >= pageSize;
    }
     ...
     */
    @Deprecated protected void onBindDefViewHolder(BaseViewHolder holder, T item) {
    }
